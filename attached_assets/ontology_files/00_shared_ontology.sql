...
('20000000-0000-0003-0000-000000000004', 'Port', 2, 'Port',
 'Maritime port facility for cargo and vessel operations. Canonical shared type for all domains.',
 '20000000-0000-0001-0000-000000000005',
 '{"type": "object", "properties": {"port_code": {"type": "string"}, "port_type": {"type": "string", "enum": ["container", "bulk", "general_cargo", "cruise", "mixed", "inland"]}, "country": {"type": "string"}, "annual_capacity_teu": {"type": "number"}, "berths_count": {"type": "integer"}, "status": {"type": "string", "enum": ["operational", "under_construction", "closed"]}}}',
 '["port", "seaport", "maritime port", "harbor", "harbour", "terminal", "port facility", "port of loading", "port of discharge", "POL", "POD"]',
 'ACTIVE', 1.0, '1.0.0', NOW()),

('20000000-0000-0003-0000-000000000005', 'Vessel', 2, 'Vessel',
 'Maritime vessel for cargo or passenger transport. Canonical shared type for all domains.',
 '20000000-0000-0003-0000-000000000003',
 '{"type": "object", "properties": {"vessel_name": {"type": "string"}, "imo_number": {"type": "string"}, "mmsi": {"type": "string"}, "vessel_type": {"type": "string", "enum": ["container", "bulk_carrier", "tanker", "cruise", "roro", "general_cargo", "reefer", "offshore"]}, "flag": {"type": "string"}, "dwt": {"type": "number"}, "teu_capacity": {"type": "integer"}, "status": {"type": "string", "enum": ["active", "laid_up", "scrapped"]}}}',
 '["vessel", "ship", "MV", "MT", "container ship", "bulk carrier", "tanker", "IMO", "MMSI", "flag state", "carrier vessel"]',
 'ACTIVE', 1.0, '1.0.0', NOW()),

('20000000-0000-0003-0000-000000000006', 'Truck', 2, 'Truck',
 'Road transport vehicle for cargo. Canonical shared type for all domains.',
 '20000000-0000-0003-0000-000000000003',
 '{"type": "object", "properties": {"registration": {"type": "string"}, "truck_type": {"type": "string", "enum": ["flatbed", "container", "tanker", "refrigerated", "dump", "van"]}, "capacity_tons": {"type": "number"}, "operator": {"type": "string"}}}',
 '["truck", "lorry", "HGV", "trailer", "flatbed", "container truck", "tanker truck", "road transport"]',
 'ACTIVE', 1.0, '1.0.0', NOW());
...
('30000000-0000-0003-0000-000000000005', 'CALLS_AT', 
 '20000000-0000-0003-0000-000000000005', '20000000-0000-0003-0000-000000000004',
 'MANY_TO_MANY',
 'Vessel calls at port',
 '["calls at", "docks at", "berths at", "arrives at", "port call", "port of call"]',
 'ACTIVE', 1.0, '1.0.0', NOW()),

('30000000-0000-0003-0000-000000000006', 'OPERATED_AT', 
 '20000000-0000-0003-0000-000000000003', '20000000-0000-0001-0000-000000000005',
 'MANY_TO_MANY',
 'Transport vehicle operates at transport facility',
 '["operates at", "based at", "stationed at", "home port", "hub"]',
 'ACTIVE', 1.0, '1.0.0', NOW());
